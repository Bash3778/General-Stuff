...
public class Follower : MonoBehaviour
{
	...
	[SerializeField] GameObject player;//The offset of the camera from the player (how far back and above the player the camera should be)
	...
	void Start () {
		Vector3 special = new Vector3 (0f, 3f, -1f);
		transform.position = player.transform.position + special;
	}
	void FixedUpdate ()
	{
